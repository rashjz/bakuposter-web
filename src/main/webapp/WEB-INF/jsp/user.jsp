                ...
                <div class="col-md-9">
                    ...
                    <div style=";margin-top: 5%" class="panel panel-default panel-table"> 
                        ...
                        <div class="panel-body">
                            ...
                            <div class="col-md-5">
                                ...
                                <div style="margin-top: 5px;" class="row"> 
                                    <form:form  method="POST"  action="uploadimage" enctype="multipart/form-data"  > 
                                        ...
                                        <div class="col-sm-10">
                                            <input type="file" id="imagefile" name="imagefile" accept="image/*" class="form-control input-sm"/>
                                            <div class="has-error">
                            ...
                            <div class="col-md-5">
                                <b style="color: #008bad">Username : </b> <sec:authentication   property="principal.users.username"/>   </br> 
                                <hr/>
                                <b style="color: #008bad">Name :</b>  <sec:authentication   property="principal.users.firstname"/>   </br>
                                <hr/>
                                <b style="color: #008bad">Last Name :</b>  <sec:authentication   property="principal.users.lastname"/>  </br> 
                            </div>
                            <!--</div>-->
                        </div> 
                    </div>
