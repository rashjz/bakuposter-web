...
<section class="content-section video-section">
    <div class="pattern-overlay">
        <a id="bgndVideo" class="player"
           data-property="{videoURL:'https://www.youtube.com/watch?v=C0P-16UCrvY',containment:'.video-section', quality:'large', autoPlay:true, mute:true, opacity:1}">bg</a>
        <div class="container">
            <div class="row">
                    ...
                    <div style="padding-top:30px;" class="panel-body">
                        ...
                        <form id="loginform" action="${loginUrl}" method="post" class="form-horizontal" role="form">
                            ...
                            <div style="margin-bottom: 25px" class="input-group">
                                ...
                                <input id="username" type="text" class="form-control" name="ssoId" value=""
                            ...
                            <div style="margin-top:10px" class="form-group">
                                ...
                                <div class="col-sm-12 controls">
                                    ...
                                    <a id="btn-fblogin1" href="<c:url value="/facebook/signin"/>"
            ...
            <div id="signupbox" style="display:none; margin-top:15%"
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                        <form:form id="signupform" class="form-horizontal" method="post" modelAttribute="userReg"
                                   action="${registerUrl}">
                            ...
                            <spring:bind path="repasswd">
                                <div class="form-group ${status.error ? 'has-error' : ''}">
                                    ...
                                    <div class="col-md-9">
                                        <form:input path="repasswd" type="password" class="form-control "
                            ...
                            <div style="border-top: 1px solid #999; padding-top:20px" class="form-group">
                                ...
                                <div class="col-md-offset-3 col-md-9">
                                    ...
                                    <a id="btn-fblogin" href="<c:url value="/facebook/signin"/>"
                                       class="btn btn-primary">
...
<div class="row">
    <div style="color: #9d9d9d" class="col-lg-6 pull-left">
        © 2016 Bütün hüquqlar qorunur. (<a href="http://rashjz.info/" target="_blank"><font
            color="#9d9d9d">rashjz.info</font></a>)
    </div>
