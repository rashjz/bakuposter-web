            ...
            <div class="row">
                ...
                <div class="col-md-9">
                                    ...
                                    <div class="thumbnail"> 
                                        ...
                                        <div class="hovereffect">
                                            <img   src="${content.imgUrl}" style="max-height: 400px;min-height: 400px;"   
                                                   onerror="this.src='${pageContext.request.contextPath}/resources/images/noimage.jpg'" class="img-responsive " >
                                            <div class="overlay"> 
                                                <h2></h2>
                                        ...
                                        <div class="caption"> 
                                            ...
                                            <!--                                            <p>
                                                                                            <!c:set var="shortDesc" value="$!{fn:substring(content.description,0,100)}"/>
                                                                                            $!{shortDesc}...
                                                                                            <a href="<!c:url value="/event?c=$!{content.recId}" />" class="read " >
                    ...
                    <div style="margin-left: 10px;margin-top: 10px;background: transparent;" class="panel"> 
                        <tag:paginate max="15" offset="${offset}"  count="${count}" uri="projects" typeId="${typeId}" keyValue="${keyValue}" next="&raquo;" previous="&laquo;" />
                    </div>
