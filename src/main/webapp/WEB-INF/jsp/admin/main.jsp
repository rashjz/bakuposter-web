            ...
            <table style="margin-top: 20px;" class="table table-striped table-hover dt-responsive">
                ...
                <c:forEach items="${contents}" var="cnt" varStatus="itr">
                    <tr>
                        ...
                        <td>${cnt.price }</td>
                        <td>
                            <a href="<c:url value="event?c=${cnt.recId }"/>" class="btn btn-success"> <span
                                    class="glyphicon glyphicon-zoom-in"></span></a>
                            <a href="<c:url value="view/${cnt.recId }"/>" class="btn btn-info"><span
                                    class="glyphicon glyphicon-edit"></span></a>
                            <a href="<c:url value="view/${cnt.recId }/delete"/>" class="btn btn-danger"><span
