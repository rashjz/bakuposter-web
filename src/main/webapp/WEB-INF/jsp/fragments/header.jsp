    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
            <ul class="nav navbar-nav">
                <li id="menulink1" ><a class="nav-link" href="${projects}?typeId=1"><spring:message
                        code="movie"/><span class="sr-only">(current)</span></a></li>
                <li id="menulink2" ><a class="nav-link" href="${projects}?typeId=2"><spring:message
                        code="concert"/></a></li>
                <li id="menulink3" ><a class="nav-link" href="${projects}?typeId=3"><spring:message
                        code="theater"/></a></li>
                <li id="menulink4" ><a class="nav-link" href="${about}"><spring:message code="about"/></a>
                </li>
                <li id="menulink5" ><a href="${contact}"><spring:message code="contact"/></a></li>
            </ul>
            ...
            <ul class="nav navbar-nav navbar-right">
                ...
                <sec:authorize access="isAuthenticated()">
                    ...
                    <li><a style="padding-top : 2px  ! important; padding-bottom: 2px ! important;"
                           href="<c:url value="/profile" />">
                        <img style="height: 40px;border: 2px solid;border-radius: 25px;"
                             onerror="www.brentfordfc.co.uk/images/common/bg_player_profile_default_big.png"
                             src="${imgUrlProfile}">
                    </a>
                    </li>
            ...
            <form action="projects" method="GET" class="navbar-form navbar-right">
                <div class="form-group has-feedback">
                    ...
                    <input id="keyValue" name="keyValue" type="text" class="form-control" name="search" id="search"
