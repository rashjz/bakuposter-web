                        ...
                        <div class="panel-body">
                            ...
                            <div class="row">
                                ...
                                <div style="margin-left: 2%" class="col-md-5">
                                    <b style="color: #008bad"><spring:message code="additional"/> : </b> ${content.description} </br>
                                    ...
                                    <b style="color: #008bad"><spring:message code="producer"/> :</b> ${content.producer}   </br>
                    ...
                    <c:choose>
                        <c:when test="${content.videoUrl!=null && content.videoUrl!=''}">
                            <div style="margin-top: 2%;" class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <center>
                                        <div style="border: none;margin-top: 2%;" class="embed-responsive embed-responsive-16by9" >
                                            <iframe class="embed-responsive-item" allowfullscreen="true"  src="https://www.youtube.com/embed/${content.videoUrl}"></iframe>
                                        </div>
                                    </center>
                                </div>
                            </div> 
...
//                            console.log(paramOne);
                    ...
                    <div  class="fb-comments" data-href="bakuposter.com/event?c=${dataCode}#configurator" data-mobile="true" data-numposts="5"></div>
                </div>
